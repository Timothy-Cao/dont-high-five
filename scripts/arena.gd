...
func stripe(pos: Vector3,size: Vector3,color: Color,basis:=Basis.IDENTITY) -> void:
	block(pos,size,color,false,basis,1.2)
...
func build() -> void:
	...
	for x in [-72,-24,24,72]:
		for z in [-72,-24,24,72]:
			...
			stripe(Vector3(x+0.57,17,z),Vector3(0.04,29,0.12),BLUE)
	...
	maze(Vector3(-69,0,30),7,7,5.5,LIME,621,false)
	maze(Vector3(30,0,30),7,7,5.5,PINK,483,true)
	maze(Vector3(-69,8.5,-69),7,7,5.5,CYAN,318,false,true)
	maze(Vector3(30,8.5,30),7,7,5.5,PINK,852,false,true)
...
func hideaway(pos: Vector3,color: Color,yaw:=0.0) -> void:
	...
	window_wall(pos+b*Vector3(4,0,0),5,3.25,[Rect2(-1,0,2,1.15)],color,yaw+PI/2)
...
func build_hideaways() -> void:
	...
	window_wall(Vector3(0,0,68.8),18,3.6,[Rect2(-8.5,0,3,3.2),Rect2(-1,0,2,1.15),Rect2(5.5,0,3,3.2)],LIME)
