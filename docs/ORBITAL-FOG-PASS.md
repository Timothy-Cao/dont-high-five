...
Settings now includes a saved **Fog distance** slider, 50–250 m in 5 m steps. Lower values make fog thicker. Default 100 m corresponds to base exponential density 0.0230, about 28% denser than the previous 0.018. Distance means approximate 90% base Fiver obscuration, not a hard clipping boundary. Existing Watcher visibility, training and temporary vision multipliers still apply. Workshop editing retains its separate thin haze; playtesting uses the chosen setting.
